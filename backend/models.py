...
class User(BaseDocument):
    ...
    password_hash: str
    name: Optional[str] = None # Added from GitHub AdminUser
    role: UserRole = UserRole.ADMIN
    restaurant_id: Optional[PyObjectId] = None
    restaurant_slug: Optional[str] = None
    is_active: bool = True
    last_login: Optional[datetime] = None # Added from GitHub AdminUser
...
class Order(BaseDocument):
    ...
    delivery_zone: Optional[str] = None # Added from GitHub Order
...
# ===== PUSH NOTIFICATION MODELS (Added from GitHub) =====
